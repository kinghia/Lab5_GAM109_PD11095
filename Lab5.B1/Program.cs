...
namespace Lab5.B1
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Name: " + user.name + " | Rank: " + user.rank + " | Tỉ lệ chiến thắng: "
                    + user.winRate + " | Thể loại: " + user.type + " | Skin: " + user.skin);
            }
            ...
            {
                Console.WriteLine("Name: " + sortedHighWinRate.name + " | Rank: " + sortedHighWinRate.rank + " | Tỉ lệ chiến thắng: "
                    + sortedHighWinRate.winRate + " | Thể loại: " + sortedHighWinRate.type + " | Skin: " + sortedHighWinRate.skin);
            }
